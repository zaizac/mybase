...
import { BsCustomDates, RangeShowTimes, DateButtons } from './themes/bs/bs-custom-dates-view.component';
...
export class BsDaterangepickerDirective
  ...
  @Input() rangeShowTime: RangeShowTimes;
  ...
  show(): void {
    ...
    this._datepickerRef = this._datepicker
      ...
      const bsDate = document.getElementsByTagName('bs-daterangepicker-container')[0].children[0];
      bsDate.setAttribute(
        'style',
  ...
  setConfig() {
    this._config = Object.assign(
      ...
      this.bsConfig,
      {
        ...
        rangeShowTime: this.rangeShowTime,
