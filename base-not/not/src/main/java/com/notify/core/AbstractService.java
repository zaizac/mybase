...
public abstract class AbstractService<S extends AbstractEntity> implements SimpleDataAccess<S> {
	...
	/* (non-Javadoc)
	 * @see com.notify.core.SimpleDataAccess#create(com.notify.core.AbstractEntity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.notify.core.SimpleDataAccess#update(com.notify.core.AbstractEntity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.notify.core.SimpleDataAccess#find(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.notify.core.SimpleDataAccess#delete(java.lang.Integer)
	 */
	@Override
	@Modifying(clearAutomatically = true)
	@Transactional(readOnly = false, rollbackFor = Exception.class)
