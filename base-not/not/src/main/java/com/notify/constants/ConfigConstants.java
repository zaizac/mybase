...
public class ConfigConstants {
	...
	public static final String BASE_PACKAGE = "com.notify";

	/** The Constant BASE_PACKAGE_REPO. */
	public static final String BASE_PACKAGE_REPO = "com.notify.dao";

	/** The Constant BASE_PACKAGE_MODEL. */
	public static final String BASE_PACKAGE_MODEL = "com.notify.model";

	/** The Constant BASE_PACKAGE_SERVICE. */
	public static final String BASE_PACKAGE_SERVICE = "com.notify.service";

	/** The Constant BASE_PACKAGE_CONTROLLER. */
	public static final String BASE_PACKAGE_CONTROLLER = "com.notify.controller";

	/** The Constant PATH_PROJ_CONFIG. */
	public static final String PATH_PROJ_CONFIG = "base.config.path";

	/** The Constant PROPERTY_FILENAME. */
	public static final String PROPERTY_FILENAME = "base-not8";
