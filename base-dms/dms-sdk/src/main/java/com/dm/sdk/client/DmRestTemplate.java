...
public class DmRestTemplate {
	...
	/**
	 * Instantiates a new dm rest template.
	 *
	 * @param sysPrefix the sys prefix
	 */
	public DmRestTemplate(String sysPrefix) {
	...
	public <T> T postForObject(String url, Object requestBody, Class<T> responseType,
		...
		try {
			...
			if (httpResponse.getStatusLine().getStatusCode() != 200) {
				...
				throw new DmException(String.valueOf(httpResponse.getStatusLine().getStatusCode()),
