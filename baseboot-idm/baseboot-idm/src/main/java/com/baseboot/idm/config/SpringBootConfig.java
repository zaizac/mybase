...
import com.baseboot.idm.config.oauth.SecurityConfig;
...
public class SpringBootConfig extends SpringBootServletInitializer {
	...
	protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
		return application.sources(SpringBootConfig.class, WebMvcConfig.class, SecurityConfig.class,
				ServiceConfig.class, SpringLdapConfig.class);
	}
	...
	public static void main(String[] args) {
		...
		SpringApplication app = new SpringApplication(SpringBootConfig.class, WebMvcConfig.class,
				SecurityConfig.class, ServiceConfig.class, SpringLdapConfig.class);
	...
	public DataSource dataSource() {
		...
		LOG.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>Password: {}", CryptoUtil.decrypt(mysqlPword, skey));
