import { Time, DateTimepickerComponentState } from './datetimepicker.models';
...
export function isValidLimit(controls: DateTimepickerComponentState, newDate: Date): boolean {
