<div layout:fragment="content">
     <div id="content-home">
     <form th:action="@{/task/task-queue}" method="post" th:object="${searchForm}"> 	
		...
		<div id="data_table">
			<input class="btnClaim" name="claim" th:type="submit" th:value="Claim" /> 
			<table id="tbl_data">		
					<tr>
				...
				<tr th:each="task : ${dataListObj}">
					<td><input type="checkbox" th:field="*{checkTaskId}" th:value="${task.taskId}" th:text="${task.refNo}"/></td>		
