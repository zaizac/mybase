...
import com.baseboot.report.config.cache.CustomRedisCacheManager;
import com.baseboot.report.config.cache.JsonRedisSerializer;
...
public class RedisCacheConfig extends CachingConfigurerSupport implements RptCacheConstants {
