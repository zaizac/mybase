...
import com.sgw.service.SgwAuditTrailService;
import com.sgw.service.SgwAuthorizationService;
import com.sgw.util.WebUtil;
...
public class AspectController {
	...
	@Autowired
	SgwAuthorizationService authSvc;

	@Autowired
	SgwAuditTrailService auditTrailSvc;
	...
	public Object profile(ProceedingJoinPoint pjp) throws Throwable {
		...
		SgwAuditTrail s = new SgwAuditTrail();
		...
		// Always save audit trail for all request
		saveAuditTrail(s);
	...
	public void logAfterThrowing(JoinPoint joinPoint, Throwable error) {
		...
		SgwAuditTrail s = (SgwAuditTrail) request.getAttribute("sgwAuditTrail");
	...
	@Async
	private void saveAuditTrail(SgwAuditTrail s) {
		try {
