...
public class SgwExceptionController {

	private static final Logger LOGGER = LoggerFactory.getLogger(SgwExceptionController.class);
	...
	private MessageResponse processError(Exception ex, int status, String code, String path) {
		LOGGER.info("SGW Response Error: {} - {}", status, ex.getMessage());
