...
public class ValidationUtil extends ValidationUtils {
	...
	public static void rejectIfInvalidFile(Errors errors, List<RefDocuments> refDocLst, FileUpload fu, String field) {
	...
	public static void rejectIfInvalidFile(Errors errors, List<RefDocuments> refDocLst, FileUpload fu, String field,
		...
		for (RefDocuments refDoc : refDocLst) {
			LOGGER.debug("RefDocument: {} - {}", refDoc.getDocId(), refDoc.isCompulsary());
	...
	public static void rejectIfInvalidFileSize(Errors errors, List<RefDocuments> refDocLst, FileUpload fu,
			String field) {
	...
	public static void rejectIfInvalidContentType(Errors errors, List<RefDocuments> refDocLst, FileUpload fu,
			String field) {
