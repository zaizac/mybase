...
public class IdmTxnCodeConstants {
	...
	public static final String IDM_USER_GROUP_BRANCH_NEW = "IDM_USER_GROUP_BRANCH_NEW";

	public static final String IDM_USER_GROUP_BRANCH_UPD = "IDM_USER_GROUP_BRANCH_UPD";

	public static final String IDM_USER_GROUP_BRANCH_DEL = "IDM_USER_GROUP_BRANCH_DEL";

	public static final String IDM_USER_GROUP_BRANCH_GET = "IDM_USER_GROUP_BRANCH_GET";

	public static final String IDM_USER_GROUP_BRANCH_FIND = "IDM_USER_GROUP_BRANCH_FIND";
	
	public static final String IDM_OAUTH_CLIENT_DETAILS_NEW = "IDM_OAUTH_CLIENT_DETAILS_NEW";

	public static final String IDM_OAUTH_CLIENT_DETAILS_UPD = "IDM_OAUTH_CLIENT_DETAILS_UPD";

	public static final String IDM_OAUTH_CLIENT_DETAILS_DEL = "IDM_OAUTH_CLIENT_DETAILS_DEL";

	public static final String IDM_OAUTH_CLIENT_DETAILS_GET = "IDM_OAUTH_CLIENT_DETAILS_GET";

	public static final String IDM_OAUTH_CLIENT_DETAILS_FIND = "IDM_OAUTH_CLIENT_DETAILS_FIND";
