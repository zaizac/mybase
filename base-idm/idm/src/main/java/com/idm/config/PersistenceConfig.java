...
public class PersistenceConfig {
	...
	public DataSource dataSource() {
		...
		return new HikariDataSource(hikariConfig(mysqlDriver, mysqlUrl, mysqlUname, mysqlPword));
	}


	private HikariConfig hikariConfig(String mysqlDriver, String mysqlUrl, String mysqlUname, String mysqlPword) {
