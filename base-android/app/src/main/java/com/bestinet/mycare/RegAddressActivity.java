...
public class RegAddressActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btnNext) {
            startActivity(new Intent(RegAddressActivity.this, RegEmployerActivity.class));
        }
    }
