...
import com.baseboot.web.exception.UnknownRequestParamException;
...
public class UnknownRequestParamInterceptor extends HandlerInterceptorAdapter {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(UnknownRequestParamInterceptor.class);
	...
	private void checkParams(HttpServletRequest request, Set<String> allowedParams) {
		...
		while (en.hasMoreElements()) {
			...
			if (!allowedParams.contains(param) && !param.contains(".")) {
				if (!checkDatatableParam(param)) {
